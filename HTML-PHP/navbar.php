<nav class="navbar navbar-default navbar-fixed-top">
    <ul class="nav nav-pills">
        <li role="presentation" class="active"><a href="http://phpstorm.localhost/" target="_blank">Accueil</a></li>
        <li role="presentation"><a href="/php_mos/HTML-PHP/date.php" target="_blank">Date</a></li>
        <li role="presentation"><a href="/php_mos/HTML-PHP/mineur_majeur.php" target="_blank">Conditions</a></li>
        <li role="presentation"><a href="/php_mos/HTML-PHP/boucles.php" target="_blank">Boucles</a></li>
        <li role="presentation"><a href="/php_mos/HTML-PHP/tableau.php" target="_blank">Tableaux</a></li>
        <li role="presentation"><a href="/php_mos/HTML-PHP/tableau2.php" target="_blank">Tableaux 2</a></li>
        ...
        <li role="presentation"><a href="http://phpstorm.localhost/php_mos/inscritption/" target="_blank">Inscription</a></li>
    </ul>
</nav>